							...
							<div class="tabbable">
						            ...
						            <div class="tab-content">
									  ...
									  <div id="profile3" class="tab-pane">
									  	...
									  	<input type="hidden" value="${pd.R3smsSound }" id="R3smsSound" name="R3smsSound" />
										<table id="table_report" class="table table-striped table-bordered table-hover">
											<tr>
												<td style="text-align: center;" colspan="100">
													微信接口配置
												...
												<td colspan="100" class="center">
													<div class="col-sm-9">
														<label style="float:left;padding-left: 1px;padding-top:7px;">
															<input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3" <c:if test="${pd.R3smsSound == '0' }">checked="checked"</c:if> onclick="setR3smsSoundType('0');"/>
															<span class="lbl">静音</span>
														</label>
													</div>
													<div class="col-sm-9">
														<label style="float:left;padding-left: 5px;padding-top:7px;">
															<input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3" <c:if test="${pd.R3smsSound == '1' }">checked="checked"</c:if> onclick="setR3smsSoundType('1');"/>
															<span class="lbl">歪歪音效</span>
														</label>
													</div>
													<div class="col-sm-9">
														<label style="float:left;padding-left: 5px;padding-top:7px;">
															<input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3" <c:if test="${pd.R3smsSound == '2' }">checked="checked"</c:if> onclick="setR3smsSoundType('2');"/>
															<span class="lbl">美女音效</span>
														</label>
													</div>
													<div class="col-sm-9">
														<label style="float:left;padding-left: 5px;padding-top:7px;">
															<input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3" <c:if test="${pd.R3smsSound == '3' }">checked="checked"</c:if> onclick="setR3smsSoundType('3');"/>
															<span class="lbl">飞信音效</span>
														</label>
													</div>
													<div class="col-sm-9">
														<label style="float:left;padding-left: 5px;padding-top:7px;">
															<input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3" <c:if test="${pd.R3smsSound == '4' }">checked="checked"</c:if> onclick="setR3smsSoundType('4');"/>
															<span class="lbl">IOS短信音效</span>
														</label>
													</div>
													<div class="col-sm-9">
														<label style="float:left;padding-left: 5px;padding-top:7px;">
															<input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3" <c:if test="${pd.R3smsSound == '5' }">checked="checked"</c:if> onclick="setR3smsSoundType('5');"/>
