...
<body>
	<div class="page-header">
		<ul class="navi">
			...
			<li><a target="mainFrame" href="tour/articleChangeLog">商品变更记录</a></li>
		</ul>
	</div>
	<div class="page-content" style="padding: 10px;">
		<div class="container-fluid">
			...
			<form action="tour/articleChangeLog" method="post" name="articleForm" id="articleForm">
...
<script>
	...
	function search(){
		...
		$("#searchForm").attr("action", "tour/articleChangeLog");
		$("#searchForm").submit();
	}
</script>
