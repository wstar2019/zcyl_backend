...
<body>
	<div class="page-header">
		<ul class="navi">
			...
			<li><a target="mainFrame" href="tour/listTourFeedback">点评管理</a><span>≫ </span></li>
			<li><a target="mainFrame" href="tour/viewFeedback?ID=${feedback.ID}">查看</a></li>
		</ul>
	</div>
	<div class="page-content" style="padding: 10px;bottom: 50px;">
		<div class="container">
			<span id="s_org_content" style="display:none;">${feedback.CONTENT}</span>
    ...
    <form action="" style="display: none;" method="post" name="feedbackForm" id="feedbackForm"></form>
...
function goListPage(){
	$("#feedbackForm").attr( "action", "tour/listTourFeedback" + "?" + $("#feedbackForm").serialize());
	$("#feedbackForm").submit();
}
