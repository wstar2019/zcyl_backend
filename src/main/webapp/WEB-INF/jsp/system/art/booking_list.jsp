...
<body>
	<div class="page-header">
		<ul class="navi">
			...
			<li><a target="mainFrame" href="sa/listBooking">订单管理</a></li>
		</ul>
	</div>
				...
				<div class="page-content" style="padding: 10px;">
					<div class="container-fluid">
						...
						<form action="sa/listBooking" method="post" name="bookingForm" id="bookingForm">
										...
										<c:when test="${not empty bookingList}">
											...
											<c:forEach items="${bookingList}" var="booking" varStatus="vs">
												...
												<tr id="${booking.id}">
													...
													<td class="center">
														<div class="btn-group">
															<a class="btn btn-minier btn-white btn_m_edit" target="mainFrame" href="sa/editBooking/?ID=${booking.id}">编辑</a>
														</div>
													</td>
												</tr>
											</c:forEach>
...
function search(){
	...
	$("#bookingEditForm").attr("action", "sa/listBooking");
