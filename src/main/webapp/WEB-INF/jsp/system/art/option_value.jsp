						...
						<!-- /section:basics/navbar.layout -->
									<div class="page-header">
										<ul class="navi">
											...
											<li><a target="mainFrame" href="sa/listOption">选项管理</a><span> ≫ </span></li>
											<li><a target="mainFrame" href="sa/listOptVal/?MID=${pd.ID}">${pd.NAME}</a></li>
										</ul>
									</div>
									<div class="page-content">
										<div class="container-fluid">
											...
											<form action="sa/listOptVal" method="post" name="optValForm" id="optValForm">
											...
											<form action="sa/saveOptVal" style="display: none;" method="post" name="optValEditForm" id="optValEditForm">
							...
							$("#simple-table").on('click', ".btn_m_delete", function () {
									...
									bootbox.confirm(options, function(result) {
										if(result) {
											...
											$("#OV_ID").val(id);
											$("#OV_MID").val(mid);
											$("#optValEditForm").attr("action", "sa/deleteOptVal" + "?" + $("#optValForm").serialize());
									...
									$.ajax({
										...
										success: function (data) {
											if ("success" == data.result) {
												...
												$("#optValEditForm").attr( "action", "sa/saveOptVal" + "?" + $("#optValForm").serialize());
												$("#optValEditForm").submit();
											} else {
