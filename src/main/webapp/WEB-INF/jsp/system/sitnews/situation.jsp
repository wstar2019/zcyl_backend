...
<body>
	<div class="page-header">
		<ul class="navi">
			...
			<li><a target="mainFrame" href="sn/listSituation">新闻管理</a><span> ≫ </span></li>
			<c:if test="${not empty situation.ID}">
				<li><a target="mainFrame" href="sn/editSituation?ID=${situation.ID}">编辑</a></li>
			</c:if>
			<c:if test="${empty situation.ID}">
				<li><a target="mainFrame" href="sn/editSituation">新增</a></li>
			</c:if>
		</ul>
	</div>
	<!-- /section:basics/navbar.layout -->
				...
				<div class="page-content" style="padding: 10px;">
					<div class="container-fluid">
						<form  action="sn/saveSituation" name="situationForm" id="situationForm" method="post" enctype="multipart/form-data">
							<div class="row input-controls">
								<div class="col-md-12">
									<div class="form-group">
										<label class="col-sm-2 control-label">标题<span class="required-item">*</span></label>
										<div class="col-sm-8">
											<input class="form-control" id="S_TITLE" type="text" value="${situation.SN_TITLE}">
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<a onclick="fileType('IMAGE_SRC')" id="IMAGE_SRC_BTN"
												class="btn btn-mini btn-success"
												style="margin-bottom:5px; height: 30px; align: center;">选择文件</a>
											<c:if test="${not empty situation.SN_IMAGE}">
												<img id="IMAGE_PREVIEW" alt="" src="uploadFiles/uploadImgs/sn/${situation.SN_IMAGE}" style="height: 45px;">
											</c:if>
											<c:if test="${empty situation.SN_IMAGE}">
											...
											<input type="text"
												...
												style="display: none;" value="${situation.SN_IMAGE}" readonly/>
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<span id="s_org_content" style="display:none;">${situation.SN_CONTENT}</span>							
											<div id="s_content_edit_area">
												<INPUT id="editor_data" type="hidden" name="S_CONTENT" value="">
												<iframe id="Web_Edit" name="Web_Edit"
													src="static/standard_editor.jsp" style="border: 0px;" width="100%" height="300"></iframe>
				            ...
				            <div class="row">
				            	...
				            	<div class="col-md-10 form-group">
				            		<button onclick="saveSituation();" class="btn btn-primary">发布</button>
		...
		$.ajax({
			...
			success: function (data) {
				if ("success" == data.result) {
					$("#situationForm").attr( "action", "sn/listSituation");
