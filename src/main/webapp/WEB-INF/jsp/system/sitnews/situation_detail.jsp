...
<body>
	<div class="page-header">
		<ul class="navi">
			...
			<li><a target="mainFrame" href="sn/listSituation">动态管理</a><span>≫ </span></li>
			<li><a target="mainFrame" href="sn/viewSituation?ID=${situation.ID}">查看</a></li>
		</ul>
	</div>
    ...
    <form action="" style="display: none;" method="post" name="situForm" id="situForm"></form>
...
function goListPage(){
	$("#situForm").attr( "action", "sn/listSituation" + "?" + $("#situForm").serialize());
	$("#situForm").submit();
}
