...
<body>
	<div class="page-header">
		<ul class="navi">
			...
			<li><a target="mainFrame" href="fp/listSlide">横幅管理</a></li>
		</ul>
	</div>
				...
				<div class="page-content" style="padding: 10px;">
					<div class="container-fluid">
						...
						<form action="fp/listSlide" method="post" name="fpSlideForm" id="fpSlideForm">
												...
												<tr id="row_${sl.id}">
													...
													<td class="center sl-name">
														<a class="btn_m_view_img" data-toggle="modal" data-target="#viewSlidingImage">
															<img style="width: 120px; height: 40px;cursor:pointer;" alt="" src="uploadFiles/uploadImgs/fp/${sl.name}">
														</a>
													</td>	
					      				...
					      				<table>
					      					<tr>
					      						...
					      						<td colspan="2">
													...
													<a id="SLIDE_IMAGE_BTN"
														onclick="fileType('SLIDE_IMAGE')"
														class="btn btn-mini btn-success"
														style="margin-bottom:5px; height: 30px; align: center;">选择文件</a>
													<img id="photo_preview" alt="" src="" style="height: 45px;">
													<input type="text" name="SLIDE_IMAGE_NAME" id="SLIDE_IMAGE_NAME" accept="image/*"
...
<script>
	...
	function search(){
		...
		$("#fpSlideForm").attr("action", "fp/listSlide/?COMMENT=" + DESC + "&STATE=" + STATE);
		$("#fpSlideForm").submit();
	}
	...
	function updateSlide(_id, _name, _desc, _vType, _vState){
		...
		$("#photo_preview").attr('src', "<%=basePath%>uploadFiles/uploadImgs/fp/" + _name);
	...
	function delSlide(_id, _name){
		var options = {
				message: "<div class='item-row'><div class='item-label'>横幅名称 :</div>" + 
						 ...
						 "<p><span class='item-info'>您确定删除吗?</span></p>",
				title: "删除横幅"
		}
		bootbox.confirm(options, function(result) {
			if(result) {
				top.jzts();
				var url = "<%=basePath%>fp/deleteSlide?ID=" + _id;
