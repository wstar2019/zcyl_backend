...
<body>
	<div class="page-header">
		<ul class="navi">
			...
			<li><a target="mainFrame" href="sp/listFeedback">评价管理</a></li>
		</ul>
	</div>
				...
				<div class="page-content" style="padding: 10px;">
					<div class="container-fluid">
						...
						<form action="sp/listFeedback" method="post" name="feedbackForm" id="feedbackForm">
...
function search(){
	...
	$("#feedbackEditForm").attr("action", "sp/listFeedback");
...
function delFeedback(_id, _user, _art){
	...
	bootbox.confirm(options, function(result) {
		if(result) {
			top.jzts();
			var url = "<%=basePath%>sp/deleteFeedback?ID=" + _id;
...
function viewFeedback(_user, _art, _content){
	var options = {
		...
		inputs:[
			...
			{"type": "textarea", "label": "点评内容", "value": _content, "idx": "content" }
		],
		btnType: 1
	};
