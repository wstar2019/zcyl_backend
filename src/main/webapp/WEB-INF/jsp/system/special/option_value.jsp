			...
			<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
				<%
						...
						<!-- /section:basics/navbar.layout -->
									<div class="page-header">
										<ul class="navi">
											...
											<li><a target="mainFrame" href="sp/listOption">选项管理</a><span> ≫ </span></li>
											<li><a target="mainFrame" href="sp/listOptVal/?MID=${pd.ID}">${pd.NAME}</a></li>
										</ul>
									</div>
									<div class="page-content">
										<div class="container-fluid">
											...
											<form action="sp/listOptVal" method="post" name="optValForm" id="optValForm">
													...
													<tbody>
														<c:choose>
															<c:when test="${not empty optionValueList}">
																...
																%>
																	<tr tr_id='${ov.ID }'>
																		<td class="center ov_no">${(page.currentPage -1) * page.showCount + numStds}</td>
											...
											<form action="sp/saveOptVal" style="display: none;" method="post" name="optValEditForm" id="optValEditForm">
					...
					<script type="text/javascript">
							...
							$("#simple-table").on('click', ".btn_m_delete", function () {
									...
									bootbox.confirm(options, function(result) {
										if(result) {
											...
											$("#OV_ID").val(id);
											$("#OV_MID").val(mid);
											$("#optValEditForm").attr("action", "sp/deleteOptVal" + "?" + $("#optValForm").serialize());
											$("#optValEditForm").submit();
										}
									});
								});
									...
									$.ajax({
										...
										success: function (data) {
											if ("success" == data.result) {
												...
												$("#optValEditForm").attr( "action", "sp/saveOptVal" + "?" + $("#optValForm").serialize());
												$("#optValEditForm").submit();
											} else {
						...
						function addCancel() {
							var strHtml = "<td colspan=\"12\" class=\"center\">+<a class=\"btn btn-primary\" onclick=\"addItem();\">新增</a></td>";
							$("#tr_add").html(strHtml);
						}
					</script>
