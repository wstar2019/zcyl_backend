...
<body>
	<div class="page-header">
		<ul class="navi">
			...
			<li><a target="mainFrame" href="sp/listArticle">商品管理</a></li>
		</ul>
	</div>
	...
	<div class="page-content" style="padding: 10px;">
		<div class="container-fluid">
			...
			<form action="sp/listArticle" method="post" name="articleForm" id="articleForm">
										...
										<td class="center">
											<div class="btn-group">
												<a class="btn btn-minier btn-white btn_m_list"
													target="mainFrame" href="sp/listBooking/?ART_ID=${article.ID}">购物管理</a>
												<a class="btn btn-minier btn-white btn_m_feedback"
													target="mainFrame" href="sp/listFeedback/?ART_ID=${article.ID}">评价管理</a>
												<a class="btn btn-minier btn-white btn_m_log"
													target="mainFrame" href="sp/listArticleUpdate/?ART_ID=${article.ID}">变更记录</a>
												<a class="btn btn-minier btn-white btn_m_edit" target="mainFrame" href="sp/editArticle/?ID=${article.ID}">编辑</a>
			...
			<form action="sp/saveOptArt" style="display: none;" method="post" name="artEditForm" id="artEditForm">
...
function search(){
	...
	$("#artEditForm").attr("action", "sp/listArticle/?" + $("#articleForm").serialize());
	$("#artEditForm").submit();
}
...
function addArticle(){
	...
	$("#OT_STIME").val("");
	$("#OT_ETIME").val("");
	$("#artEditForm").attr("action", "sp/editArticle/?" + $("#articleForm").serialize());
	$("#artEditForm").submit();
}
...
function confirmDelete(){
	...
	top.jzts();
	var url = "<%=basePath%>sp/deleteArt?ID=" + _id;
