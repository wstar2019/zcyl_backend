...
<body>
	<div class="page-header">
		<ul class="navi">
			...
			<li><a target="mainFrame" href="sp/listSlide">横幅管理</a></li>
		</ul>
	</div>
				...
				<div class="page-content" style="padding: 10px;">
					<div class="container-fluid">
						...
						<form action="sp/listSlide" method="post" name="spSlideForm" id="spSlideForm">
											...
											<c:forEach items="${slideList}" var="sl" varStatus="vs">
												...
												<tr id="row_${sl.id}">
													...
													<td class="center sl-name">
														<img style="width: 120px; height: 40px;" alt="" src="uploadFiles/uploadImgs/sp/${sl.name}"></td>
...
<script>
	...
	function search(){
		...
		$("#spSlideForm").attr("action", "sp/listSlide/?COMMENT=" + DESC + "&STATE=" + STATE);
		$("#spSlideForm").submit();
	}
	...
	function updateSlide(_id, _name, _desc, _vType, _vState){
		...
		$("#SLIDE_IMAGE_PREVIEW").attr('src', "uploadFiles/uploadImgs/sp/" + _name);
	...
	function delSlide(_id, _comment, _name){
		...
		bootbox.confirm(options, function(result) {
			if(result) {
				top.jzts();
				var url = "<%=basePath%>sp/deleteSlide?ID=" + _id + "&NAME=" + _name;
