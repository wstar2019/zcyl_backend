...
var KE_TITLE_value = '<div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H1\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H1 style="margin:2px;">표제 1</H1></div><div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H2\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H2 style="margin:2px;">표제 2</H2></div><div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H3\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H3 style="margin:2px;">표제 3</H3></div><div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H4\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H4 style="margin:2px;">표제 4</H4></div><div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H5\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H5 style="margin:2px;">표제 5</H5></div><div style="width:140px;cursor:pointer;" onclick="javascript:KindExecute(\'KE_TITLE_END\', \'H6\');" onmouseover="javascript:this.style.backgroundColor=\'#CCCCCC\';" onmouseout="javascript:this.style.backgroundColor=\'#EFEFEF\';"><H6 style="margin:2px;">표제 6</H6></div>';
...
var KE_ABOUT_str = '<div id="POPUP_KE_ABOUT" style="width:230px;position:absolute;top:1px;left:1px;font-size:12px;color:#222222;background-color:#EFEFEF;border:solid 1px #AAAAAA;z-index:1;display:none;;padding:5px;"><span style="margin-right:10px;">KindEditor 2.5.4</span><a href="http://www.kindsoft.net/" target="_blank" style="color:#4169e1;" onclick="javascript:KindDisableMenu();">·ÃÎÊ¼¼ÊõÖ§³ÖÍøÕ¾</a><br /></div>';
var KE_IMAGE_str = '<div id="POPUP_KE_IMAGE" style="width:350px;position:absolute;top:1px;left:1px;font-size:12px;color:#222222;background-color:#EFEFEF;border:solid 1px #AAAAAA;z-index:1;display:none;"><iframe name="KindImageIframe" id="KindImageIframe" frameborder="0" style="width:350px;height:80px;padding:0;margin:0;border:0;"></iframe></div>';
...
var KE_FLASH_str = '<div id="POPUP_KE_FLASH" style="width:350px;position:absolute;top:1px;left:1px;font-size:12px;color:#222222;background-color:#EFEFEF;border:solid 1px #AAAAAA;z-index:1;display:none;"><iframe name="KindFlashIframe" id="KindFlashIframe" frameborder="0" style="width:350px;height:120px;padding:0;margin:0;border:0;"></iframe></div>';
var KE_MEDIA_str = '<div id="POPUP_KE_MEDIA" style="width:350px;position:absolute;top:1px;left:1px;font-size:12px;color:#222222;background-color:#EFEFEF;border:solid 1px #AAAAAA;z-index:1;display:none;"><iframe name="KindMediaIframe" id="KindMediaIframe" frameborder="0" style="width:350px;height:120px;padding:0;margin:0;border:0;"></iframe></div>';
...
var KE_HEIGHT = "400px";
var KE_SITE_DOMAIN = "";
//var KE_SKIN_PATH  = "http://150.30.22.108:8080/webeditor/ewebeditor/skins/default/";
var KE_SKIN_PATH  = "webeditor/ewebeditor/skins/default/";
var KE_ICON_PATH = "/images/default/faceicon/";
var KE_IMAGE_ATTACH_PATH = "upload_files/";
//var KE_IMAGE_UPLOAD_CGI = "http://150.30.22.108:8080/webeditor/upfile_eweb.jsp";
var KE_IMAGE_UPLOAD_CGI = "webeditor/upfile_eweb.jsp";
//var KE_CSS_PATH = "http://150.30.22.108:8080/webeditor/ewebeditor/common.css";
var KE_CSS_PATH = "webeditor/ewebeditor/common.css";
var KE_MENU_BORDER_COLOR = '#AAAAAA';
var KE_MENU_BG_COLOR = '#EFEFEF';
var KE_MENU_TEXT_COLOR = '#222222';
var KE_MENU_SELECTED_COLOR = '#CCCCCC';
var KE_TOOLBAR_BORDER_COLOR = '#416cc7';
var KE_TOOLBAR_BG_COLOR = '#EFEFEF';
var KE_FORM_BORDER_COLOR = '#DDDDDD';
var KE_FORM_BG_COLOR = '#FFFFFF';
var KE_BUTTON_COLOR = '#AAAAAA';
var KE_LANG = {
	INPUT_URL		: "정확한 url주소를 입력하시오",
	SELECT_IMAGE	: "삽입할 그림을 선택하시오",
	INVALID_IMAGE	: "GIF,JPG,PNG,BMP파일만 허용합니다.",
	INVALID_FLASH	: "swf파일만 허용합니다.",
	INVALID_MEDIA	: "MP3,WAV,WMA,WMV,MID,AVI,MPG,ASF파일만 허용합니다.",
	INVALID_REAL	: "RM,RMVB파일만 허용합니다.",
	INVALID_WIDTH	: "这里只能输入数字.",
	INVALID_HEIGHT	: "请输入数字.",
	INVALID_BORDER	: "请输入数字",
	INVALID_HSPACE	: "请输入数字",
	INVALID_VSPACE	: "请输入数字",
	INPUT_CONTENT	: "请输入内容.",
	TITLE			: "题目",
	WIDTH			: "宽度",
	HEIGHT			: "高度",
...
var KE_FONT_NAME = Array(
	Array('PRK P Gothic', '청봉'), 
	Array('KP CheonRiMa', '천리마'), 
	Array('PRK P Chongbong', '청봉체'), 
	Array('KP KwangMyeong', '광명'), 
	Array('PRK P Bukul', '붓글'), 
	Array('Arial', 'Arial'), 
...
var KE_TOP_TOOLBAR_ICON = Array(
	...
	Array('KE_INDENT', 'indent.gif', '减少缩进量'),
	Array('KE_OUTDENT', 'outdent.gif', '增加缩进量'),
	Array('KE_SUBSCRIPT', 'subscript.gif', '下标'),
	Array('KE_SUPERSCRIPT', 'superscript.gif', '上标'),
	Array('KE_DATE', 'date.gif', '插入日期'),
	Array('KE_TIME', 'time.gif', '插入时间'),
	Array('KE_BOKECC', 'bokecc.gif', 'CCÊÓÆµ')
);
var KE_BOTTOM_TOOLBAR_ICON = Array(
//	Array('KE_TITLE', 'title.gif', '표제'),
	Array('KE_FONTNAME', 'font.gif', '字体'),
	Array('KE_FONTSIZE', 'fontsize.gif', '字号'),
	Array('KE_TEXTCOLOR', 'textcolor.gif', '字体颜色'),
	Array('KE_BGCOLOR', 'bgcolor.gif', '背景颜色'),
	Array('KE_BOLD', 'bold.gif', '加粗'),
	Array('KE_ITALIC', 'italic.gif', '倾斜'),
	Array('KE_UNDERLINE', 'underline.gif', '下划线'),
	Array('KE_STRIKE', 'strikethrough.gif', '删除线'),
	Array('KE_REMOVE', 'removeformat.gif', '清除格式'),
	Array('KE_IMAGE', 'image.gif', '插入图片'),
//	Array('KE_FLV', 'flv.gif', 'flv삽입'),
//	Array('KE_MYFILES', 'file.gif', '파일삽입'),
//	Array('KE_FLASH', 'flash.gif', 'Flash'),
//	Array('KE_MEDIA', 'media.gif', 'Windows Media Player'),
//	Array('KE_REAL', 'real.gif', 'Real Player'),
	Array('KE_LAYER', 'layer.gif', '插入层'),
	Array('KE_TABLE', 'table.gif', '插入表格'),
	Array('KE_SPECIALCHAR', 'specialchar.gif', '插入符号'),
	Array('KE_HR', 'hr.gif', '插入界线')
//	Array('KE_ICON', 'emoticons.gif', '개성화삽입'),
//	Array('KE_LINK', 'link.gif', '´´련결'),
//	Array('KE_UNLINK', 'unlink.gif', '련결취소')
);
var KE_SIMPLE_TOOLBAR_ICON = Array(
	Array('KE_FONTNAME', 'font.gif', '서체'),
	Array('KE_FONTSIZE', 'fontsize.gif', '서체크기'),
	Array('KE_TEXTCOLOR', 'textcolor.gif', '서체색'),
	Array('KE_BGCOLOR', 'bgcolor.gif', 'ÎÄ×Ö±³¾°'),
	Array('KE_BOLD', 'bold.gif', '´ÖÌå'),
	Array('KE_ITALIC', 'italic.gif', 'Ð±Ìå'),
	Array('KE_UNDERLINE', 'underline.gif', 'ÏÂ»®Ïß'),
	Array('KE_JUSTIFYLEFT', 'justifyleft.gif', '×ó¶ÔÆë'),
	Array('KE_JUSTIFYCENTER', 'justifycenter.gif', '¾ÓÖÐ'),
	Array('KE_JUSTIFYRIGHT', 'justifyright.gif', 'ÓÒ¶ÔÆë'),
	Array('KE_IMAGE', 'image.gif', '그림삽입'),
	Array('KE_LAYER', 'layer.gif', '층삽입'),
	Array('KE_HR', 'hr.gif', '가로선삽입'),
	Array('KE_ICON', 'emoticons.gif', 'Ð¦Á³'),
	Array('KE_LINK', 'link.gif', '´´½¨³¬¼¶Á¬½Ó'),
	Array('KE_ABOUT', 'about.gif', '¹ØÓÚ')
);
...
function KindDrawImageP8FLVEnd(cmd)
{
	...
	if (type == 1) {
		...
		OBJ.getElementById('uploadForm').action+="?Ctype="+cmd+"&imgWidth="+width+"&imgHeight="+height;  //  여기까지는 정상으로 동작
	} else {
...
function KindInsertImageP8FLV(url, width, height, cmd)
{
	...
	if(cmd=='KE_FLV'){
		...
		str="<a style=\"COLOR: red\" href='"+url+"' target=_blank p8name=\"p8download\">화일삽입</a>";
	}else{
		str='take a test';
	}
...
function KindEditor(objName) 
{
	...
	this.show = function()
	{
		...
		htmlData += '<div style="'+';border:1px solid ' + KE_TOOLBAR_BORDER_COLOR + ';background-color:'+ KE_TOOLBAR_BG_COLOR +'">';
		htmlData += KindCreateToolbar();
		htmlData += '</div><div id="KindEditorIframe" style="' + heightStyle + 
...
function set_ccflv(url)
{
	...
	KindDisableMenu();
	KindReloadIframe();
	alert("ÉÏ´«³É¹¦,Çë×¢Òâ,²»ÄÜÂíÉÏ²¥·Å,ÒªµÈ´ýÉóºËºó²ÅÄÜ²¥·Å.");
}
