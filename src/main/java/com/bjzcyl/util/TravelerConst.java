...
public class TravelerConst {
	public static final String SESSION_SECURITY_CODE = "sessionTravelerSecCode";//验证码
	public static final String SESSION_TRAVELER = "sessionTraveler";
	
	public static final String APPLICATION_BASE_PATH = "basepath";
	public static final String SQ_NAME = "sqname";//社区名称
