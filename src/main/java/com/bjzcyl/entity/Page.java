	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){				
				...
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage("+(currentPage-1)+")\">《上一页</a></li>\n");
			}
			...
			if(currentPage==totalPage){
				...
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage("+(currentPage+1)+")\">下一页》</a></li>\n");
				// sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage("+totalPage+")\">尾页</a></li>\n");
			}
			sb.append("	<li><a>当前"+currentPage+"/"+showCount+"条 , 共"+totalResult+"条</a></li>\n");			
